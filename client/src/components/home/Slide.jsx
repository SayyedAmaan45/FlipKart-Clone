...
const ViewAllBtn = styled(Button)`
    ...
    border-radius: 2px;  /* Corrected the typo */
    font-size: 13px;
    font-weight: 600;
`;
...
function Slide({ products, title, timer, category }) {
    ...
    return (
        <Components>
            <Deal>
                ...
                <Link to={`/products/category/${category}`} onClick={() => window.scrollTo(0, 0)} style={{ textDecoration: 'none' }}>
